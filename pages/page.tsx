  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-black/10 bg-white/95 backdrop-blur-sm">
        <div className="mx-auto grid h-16 max-w-7xl grid-cols-3 items-center px-6 md:px-12 lg:px-16 text-[11px] tracking-[0.2em]">
          {/* Left Nav */}
          ...
          <div className="flex justify-center">
            <div className="text-base tracking-[0.35em] font-medium">AUTOCUT</div>
          </div>
          {/* Right Nav */}
          <div className="flex items-center justify-end gap-6">
            ...
            <button className="border border-black px-5 py-2 text-[10px] tracking-[0.2em] transition-all hover:bg-black hover:text-white whitespace-nowrap">
              START TRIAL
            </button>
          </div>
        </div>
