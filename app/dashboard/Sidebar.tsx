...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 flex-shrink-0 hidden md:flex flex-col border-r border-black/[0.08] bg-white/40 backdrop-blur-2xl h-screen sticky top-0">
            <div className="h-20 flex items-center px-8 border-b border-black/[0.05]">
                <Link href="/" className="font-semibold text-lg hover:opacity-70 transition-opacity flex items-center gap-2">
