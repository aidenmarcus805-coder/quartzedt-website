...
function SignInContent() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center bg-[#FAF9F6] overflow-hidden font-sans">
      ...
      {/* Background Image - Absolute Professional Abstract */}
      ...
      <div className="relative z-10 w-full max-w-[1240px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <div className="flex-1">
            <h1 className="text-[32px] font-bold mb-2 tracking-tight text-[#222222] font-display">Sign in</h1>
            <p className="text-[14px] text-gray-500 mb-10">
              New user? <Link href="/signup" className="text-gray-800 hover:text-black underline decoration-gray-200 underline-offset-4 font-medium transition-colors">Create an account</Link>
            </p>
                ...
                <AnimatePresence initial={false} mode="wait">
                  {step === 1 ? (
                    <motion.div
                      ...
                      className="space-y-1"
                    >
                      <div className="space-y-1.5 mb-1 relative">
                    ...
                    >
                      <div className="space-y-1 mb-2">
                        <label className="block text-[12px] font-medium text-gray-600 ml-1">Email address</label>
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                          <span className="text-[14px] text-gray-600 font-medium truncate max-w-[200px]">{email}</span>
                          <button type="button" onClick={() => { setStep(1); setError(null); }} className="text-[13px] text-gray-800 font-medium hover:text-black underline decoration-gray-200 underline-offset-4 transition-colors">Change</button>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-center mt-0 transform scale-[0.8] origin-center bg-gray-50 p-1 rounded-lg border border-gray-100">
                        <Turnstile
